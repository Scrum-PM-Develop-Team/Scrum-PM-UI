<template>
    <div>
        <el-table :data="allData" @row-click="handleCurrentChange">
            ...
            <el-table-column prop="teamProjectName" label="当前迭代" width="100"></el-table-column>
            <el-table-column prop="teamProjectName" label="队长" width="100"></el-table-column>
            <el-table-column prop="teamProjectName" label="我的身份" width="100"></el-table-column>
